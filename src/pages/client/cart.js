            ...
            <div class="my-4 mt-6 -mx-2 lg:flex">
              <div class="lg:px-2 lg:w-1/2">
                ...
                <div class="p-4 mt-6 bg-gray-100 rounded-full">
                  <h1 class="ml-2 font-bold uppercase">Delivery information</h1>
                </div>
                <div class="p-4">
                <div class="name">
                    <p class="mb-4 italic">Name</p>
                    <input class="w-full  p-2 bg-gray-100 rounded" type="text" name="name" name="" id="">
                </div>
                <div class="phone">
                    <p class="mb-4 italic">Phone</p>
                    <input class="w-full  p-2 bg-gray-100 rounded" type="text" name="phone" name="" id="">
                </div>
                <div class="address">
                    <p class="mb-4 italic">Address</p>
