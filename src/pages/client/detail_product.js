...
const detail_product = {
    async render(id) {
        ...
        return /*html*/ `
            <section class="mx-auto text-gray-700 body-font overflow-hidden bg-white">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div class="flex">
                            <span class="title-font font-medium text-2xl text-gray-900">${data.price} VNĐ</span>
                    ...
                    <h1 class="pt-10 text-gray-900 text-3xl title-font font-medium mb-1">Chi Tiết Bài Viết</h1>
                    
                    <p class="p-2 leading-relaxed">${data.detail}</p>
                </div>
