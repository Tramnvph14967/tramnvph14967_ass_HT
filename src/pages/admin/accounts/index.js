...
import { getAll, remove } from '../../../api/account';
          ...
          <div class="flex flex-col">
              <div>
                  <td class="px-6 py-4 text-right text-sm font-medium w-2">
                      <a href="/admin/accounts/add" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-900 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add_Accounts</a>
                  </td>
              </div>
                          ...
                          <table class="min-w-full divide-y divide-gray-200">
                              <thead class="bg-gray-50">
                                  <tr>
                                      ...
                                      <th scope="col" class="px-6 py-3 text-center text-left text-xs font-medium text-gray-900 uppercase tracking-wider">lastname</th>
                                      <th scope="col" class="px-6 py-3 text-center text-left text-xs font-medium text-gray-900 uppercase tracking-wider">firstname</th>
                                      ...
                                      <th scope="col" class="w-10 px-6 py-3 text-center text-left text-xs font-medium text-gray-900 uppercase tracking-wider">password</th>
                              ...
                              <tbody class="bg-white divide-y divide-gray-200">
                                  ...
                                  <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="w-2 px-2 py-2 text-sm text-gray-700">
                                        ${users.password}
                                    </td>
                                    <td class="px-2 py-2 text-sm text-gray-700">
                                        ${users.phone}
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <button data-id=${users.id} class="bnt btn-remove inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Delete</button>
                                    </td>
                                    </td>
                                  </tr>
                      `).join("")}
